  ...
  function renderReturnedRecords(records) {
    ...
    records.forEach((r) => {
      ...
      tr.innerHTML = [
        ...
        '<button type="button" class="btn-audit-trail btn-brand btn-brand-secondary" style="padding:4px 10px;font-size:0.75rem;border-radius:6px;margin-left:4px;" data-audit-table="medical_aid" data-audit-record-id="', r.record_id, '">Audit</button>',
        '</td>',
      ].join("");
