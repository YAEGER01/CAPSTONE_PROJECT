...
for idx, chunk in enumerate(script_blocks, 1):
    if 'application/json' in chunk or 'django-members-data' in chunk or 'django-fees-data' in chunk or 'django-otc-dues-data' in chunk or 'django-salary-data' in chunk or 'django-medical-data' in chunk or 'django-death-data' in chunk:
        print('skip block', idx, 'json bridge')
        continue
